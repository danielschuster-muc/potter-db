...
`/v1/characters?filter[name_cont_any]=Harry` to filter by the name `Harry`.
...
`/v1/characters?sort=name` to sort all characters by name
...
`/v1/characters?page[number=10]&page[size=20]` to display the results of page 10 with 20 results per page
